...
Decided not to use this data because the heatmap of Woolly Pyrol 1 yields that I create does not match the heatmap given in Appendix I.  Especially the leftmost plots in the 4th and 5th row.
