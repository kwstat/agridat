...
This experiment was a repeat of the classic experiment by Mercer and
Hall, conducted at State Research Farm, Werribee, Victoria, Australia.

Planted 1926. Harvested 1927. An acre of land was selected. Each plot
...
The field was marked into quarters and one quarter was subdivided and
harvested at a time.
...
Note: It is not clear how a strip "a few yards wide" could be omitted
and yet the dimensions of the whole area still be 300 x 320 links.

Since the omitted strip is about 1/3 the width of a plot, we (agridat
authors) decided to ignore the omitted strip.

Transcription details: This electronic data was manually typed from the
source on 2023-04-12. Summary statistics of this electronic data differ
slightly from the summaries in Forster, indicating possible typos or
rounding of the printed yield values in the paper. Values were checked
by hand and match the paper.

## Source

Forster, Howard Carlyle and A. J. Vasey (1928). Experimental error of
field trials in Australia. Proceedings of the Royal Society of Victoria.
New series, 40, 70–80. Table 1.
...
https://archive.org/details/journaldepartmev30pvictb/page/34
