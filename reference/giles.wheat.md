...
Straw length and ear emergence for wheat genotypes. Data are unbalanced
with respect to experiment year and genotype.
...
Highly unbalanced data of straw length and ear emergence date for wheat
genotypes.

The 'genotype' column is called 'Accession number' in original data. The
genotypes were chosen to represent the range of variation in the trait.

The Julian date was found to be preferable to other methods (such as
days from sowing).

Piepho (2003) fit a bilinear model to the straw emergence data. This is
similar to Finlay-Wilkinson regression.

## Source

R. Giles (1990). Utilization of unreplicated observations of agronomic
characters in a wheat germplasm collection. In: *Wheat Genetic
Resources. Meeting Diverse Needs*. Wiley, Chichester, U.K., pp.113-130.

## References

Piepho, HP (2003). Model-based mean adjustment in quantitative germplasm
evaluation data. *Genetic Resources and Crop Evolution*, 50, 281-290.
