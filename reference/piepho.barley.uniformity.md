...
Note: The paper by Piepho says "The trial had 30 rows and 36 columns.
Plot widths were 1.90 m along rows and 3.73 m along columns." This is
confirmed by the variograms in Figure 1. It is not clear what "along
rows" and "along columns" means in English.
...
H. P. Piepho & E. R. Williams (2010). Linear variance models for plant
