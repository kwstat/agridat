...
The previous yield is the number of boxes of fruit, for the four seasons
previous to the application of the treatments.

## Source

S. C. Pearce (1953). *Field Experiments With Fruit Trees and Other
Perennial Plants*. Commonwealth Bureau of Horticulture and Plantation
Crops, Farnham Royal, Slough, England, App. IV.

## References

James G. Booth, Walter T. Federer, Martin T. Wells and Russell D.
Wolfinger (2009). A Multivariate Variance Components Model for Analysis
of Covariance in Designed Experiments. *Statistical Science*, 24,
223-237.
