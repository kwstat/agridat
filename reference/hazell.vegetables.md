...
The example shows how to use linear programming to maximize expected
profit.

## Source

P.B.R. Hazell, (1971). A linear alternative to quadratic and
semivariance programming for farm planning under uncertainty. *Am. J.
Agric. Econ.*, 53, 53-62. https://doi.org/10.2307/3180297

## References

Carlos Romero, Tahir Rehman. (2003). *Multiple Criteria Analysis for
Agricultural Decisions*. Elsevier.
