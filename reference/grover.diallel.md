...
Note: The mean for the 2x2 cross is slightly different than Grover p.
252. There appears to be an unknown error in the one of the 4 reps in
the data on page 250.
