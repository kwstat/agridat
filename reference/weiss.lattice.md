...
Yield test of 49 soybean varieties, grown at Ames, IA, in 1938. Plot
dimensions were 3x16 feeet. The varieties are compared to variety 26
(Mukden).
...
giving the appearance of the reps being stacked on top of each other. On
the other hand, the analysis by Weiss uses 24 degrees of freedom
4\*(7-1) to fit a separate effect for each column in each rep (instead
of across reps).
...
Numbers of Soybean Varieties. Table 5. *Agricultural Research Bulletins,
Nos. 251-259*. https://lib.dr.iastate.edu/ag_researchbulletins/24/
