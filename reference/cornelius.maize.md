...
P L Cornelius and J Crossa and M S Seyedsadr. (1996). Statistical Tests
and Estimators of Multiplicative Models for Genotype-by-Environment
Interaction. Book: *Genotype-by-Environment Interaction*. Pages 199-234.

## References

Forkman, Johannes and Piepho, Hans-Peter. (2014). Parametric bootstrap
methods for testing multiplicative terms in GGE and AMMI models.
*Biometrics*, 70(3), 639-647. https://doi.org/10.1111/biom.12162
