...
One data value was modified from the original (following the example of
other authors).
...
Line-Source Sprinkler System. *Soil Science Society of America Journal*,
44, 886-888. https://doi.org/10.2136/sssaj1980.03615995004400040048x

## References

Johnson, D. E., Chaudhuri, U. N., and Kanemasu, E. T. (1983).
Statistical Analysis of Line-Source Sprinkler Irrigation Experiments and
Other Nonrandomized Experiments Using Multivariate Methods. Soil Science
Society American Journal, 47, 309-312.

Stroup, W. W. (1989). Use of Mixed Model Procedure to Analyze Spatially
Correlated Data: An Example Applied to a Line-Source Sprinkler
Irrigation Experiment. Applications of Mixed Models in Agriculture and
Related Disciplines, Southern Cooperative Series Bulletin No. 343,
104-122.
