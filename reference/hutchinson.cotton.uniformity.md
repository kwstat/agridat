...
K.Wright used the pdf to manually type the values into an Excel file and
checked the hand-typed values. Plants marked as "Dead" on the PDF were
left blank. There were 6 numbers that were illegible in the PDF. These
