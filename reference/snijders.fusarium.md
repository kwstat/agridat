...
The data are the percent of leaf area affected by Fusarium head blight,
...
year-strain, but additional multiplicative effects for the interactions.

Note, the value for strain F348 in 1988, gen SVP75059-32 should be 28.3
(as shown in VanEeuwijk 1995) and not 38.3 (as shown in Snijders 1991).

Used with permission of Fred van Eeuwijk.

## Source

Snijders, CHA and Van Eeuwijk, FA. 1991. Genotype x strain interactions
for resistance to Fusarium head blight caused by Fusarium culmorum in
winter wheat. Theoretical and Applied Genetics, 81, 239–244. Table 1.
https://doi.org/10.1007/BF00215729

## References

Fred A van Eeuwijk. 1995. Multiplicative interaction in generalized
