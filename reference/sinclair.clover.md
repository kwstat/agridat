...
A phosphorous by sulfur factorial experiment at Dipton in Southland, New
Zealand. There were 3 reps. Plots were harvested repeatedly from Dec
1992 to Mar 1994. Yields reported are the total dry matter across all
cuttings.

## Source

Sinclair AG, Risk WH, Smith LC, Morrison JD & Dodds KG (1994) Sulphur
and phosphorus in balanced pasture nutrition. *Proc N Z Grass Assoc*,
56, 13-16.

## References

Dodds, KG and Sinclair, AG and Morrison, JD. (1995). A bivariate
response surface for growth data. *Fertilizer research*, 45, 117-122.
