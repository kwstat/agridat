...
In their paper, the labels on the location dendrogram have a slight
typo. The order of the loc labels shown is 1 2 3 4 5 6 7. The correct
order of the loc labels is 1 2 4 5 6 7 3.

Used with permission of Jean-Baptiste Denis.

## Source

L C A Corsten and J B Denis, (1990). Structuring Interaction in Two-Way
Tables By Clustering. Biometrics, 46, 207–215. Table 1.
