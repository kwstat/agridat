...
The cork data gives the weights of cork borings of the trunk for 28
trees on the north (N), east (E), south (S) and west (W) directions.
...
Structures for Repeated Measures. *Journal of Agricultural, Biological,
