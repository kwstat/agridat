...
locations across two years in Australia. This is four-way data of Year x
Loc x Gen x Trait.
...
Measurement are available from four locations in Queensland, Australia
in two consecutive years 1970, 1971.
...
multiresponse data illustrated with a plant breeding trial. Chapman and
Hall/CRC.
...
Multi-Attribute Genotype Response Across Environments, Aust J Agric Res,
33, 473–480.
...
Marcin Kozak (2010). Use of parallel coordinate plots in multi-response
selection of interesting genotypes. Communications in Biometry and Crop
Science, 5, 83-95.
