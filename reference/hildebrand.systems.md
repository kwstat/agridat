...
On each farm, four different cropping systems were tested. The systems
were: LM = Local Maize, LMF = Local Maize with Fertilizer, CCA =
Improved Composite, CCAF = Improved Composite with Fertilizer.

## Source

P. E. Hildebrand, 1984. Modified Stability Analysis of Farmer Managed,
On-Farm Trials. *Agronomy Journal*, 76, 271–274.
https://doi.org/10.2134/agronj1984.00021962007600020023x

## References

H. P. Piepho, 1998. Methods for Comparing the Yield Stability of
Cropping Systems. *Journal of Agronomy and Crop Science*, 180, 193–213.
