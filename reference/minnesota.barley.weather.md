...
availability of weather data in the given time frame (1927-1936) and the
proximity to the town (site) for the barley data.
...
'cdd' are cooling degree days, which is the number of degree days with a
temperature \_above\_ 65 Fahrenheit.
