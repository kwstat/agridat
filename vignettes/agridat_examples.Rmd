...
```{r packs, eval=FALSE, message=FALSE}
library("agridat")
library("desplot")
library("gge")
library("HH")
...
```{r lee1, eval=FALSE, fig.height=7.5}
...
```{r harrison, eval=FALSE, fig.height=6}
...
```{r keen, eval=FALSE, fig.width=7, fig.height=7.5}
...
```{r lasrosas, eval=FALSE, fig.height=7.5}
...
```{r nass, eval=FALSE, fig.height=8}
data(nass.corn)
dat <- nass.corn
