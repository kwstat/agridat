...
```{r packs, eval=TRUE, message=FALSE, echo=TRUE}
library("agridat")
library("desplot")
library("gge")
library("HH")
...
```{r lee1, eval=TRUE, fig.height=7.5}
...
central 95 percent of the binomial density at that position.
...
(using interaction plots) in data.  Rice yield is plotted
...
```{r crossa, eval=TRUE, message=FALSE}
...
block/group of environments.  Each location is
...
was affected by field topography and nitrogen fertilizer.  The figures here
