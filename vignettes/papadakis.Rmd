...
@papadakis1937method believed that traditional blocking in field experiments did not adequately
represent the patchiness of soil fertility patterns and he instead proposed
adjusting the yield of each plot by the performance of the neighboring plots.
