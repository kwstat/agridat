...
---
title: "Additional agricultural data"
author: "Kevin Wright"
date: "`r Sys.Date()`"
output:
  html_document:
...
Master thesis. Department of Statistics, Addis Ababa University.  At least one dataset from wheat, RCB, with field coordinates.
See also http://www.ethstat.org.et/esa_publications.html, Volume 19


### Das & Giri. Design and Analysis of Experiments
```
...
### Federer, Walt. Experimental Design
```
192 3x3 factorial 
204 3x2 factorial 
...
### Kang, Manjit. Handbook of Formulas and Software for Plant Geneticists and Breeders
```
```
...
### LeClerg et al. Field Plot Technique
...
### Mead et al. Statistical Methods in Agriculture and Experimental Biology, 3rd ed
```
...
### Paterson, D. Statistical Technique in Agricultural Research
```
...
### Steel & Torrie. Principles and Procedures of Statistics, 2nd ed.
```
...
### Schabenberger and Francis J. Pierce. Contemporary Statistical Models for the Plant and Soil Sciences
Many datasets
