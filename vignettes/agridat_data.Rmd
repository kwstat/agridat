...
Equivalence testing using existing reference data: An example with genetically modiﬁed and conventional crops in animal feeding studies.
...
https://cran.r-project.org/web/packages/statgenSTA/vignettes/statgenSTA.html
